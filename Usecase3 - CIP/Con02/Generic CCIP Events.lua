...
return EVENTS:RUN(CONF, mapping_table, equipment)]=],
		...
		["CustomOptions.CustomProperties.CustomPropertyValue"] = {
			"/System/Core/ATLNZ-Relay/ATLNZ/ATLNZ-V305-Con02/1823907_PLS4000_ATS00753/PROD/GenTemplate Companions/Generic CCIP-Mapping.TableData",
			"PROD",
		},
		...
		references = {
			{
                path = "/System/Core/ATLNZ-Relay/ATLNZ/ATLNZ-V305-Con02/1823907_PLS4000_ATS00753/PROD/LIQS/4201__CIPSIP_1/CIPSIP_1__1818971/trigg_report",
                name = '_trigger_io_',
                type = 'OBJECT_LINK'
            }
        }

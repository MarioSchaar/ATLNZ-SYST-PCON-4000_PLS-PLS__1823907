...
return EVENTS:RUN(CONF, mapping_table, equipment)]=],
		...
		["CustomOptions.CustomProperties.CustomPropertyValue"] = {
			"/System/Core/ATLNZ-Relay/ATLNZ/ATLNZ-V305-Con02/1823907_PLS4000_ATS00753/PROD/GenTemplate Companions/Generic KS2-Mapping.TableData",
			"PROD",
		},
		...
		references = {
			{
                path = "/System/Core/ATLNZ-Relay/ATLNZ/ATLNZ-V305-Con02/1823907_PLS4000_ATS00753/PROD/LIQS/4128_AL10__1825145/090_Kuehlstation_2__1823585/trigg_report",
                name = '_trigger_io_',
                type = 'OBJECT_LINK'
            }
        }

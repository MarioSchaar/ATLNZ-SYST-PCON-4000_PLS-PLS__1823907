local base = "/System/Core/ATLNZ-Relay/ATLNZ/ATLNZ-V305-Con02/1823907_PLS4000_ATS00753/PROD/GenTemplate Companions"

syslib.mass({
	{
		class = syslib.model.classes.ActionItem,
		operation = syslib.model.codes.MassOp.UPSERT,
		path =  base .. "/Generic R215 Events",
		["ObjectName"] = "Generic R215 Events",
...
return EVENTS:RUN(CONF, mapping_table, equipment)]=],
		...
		["CustomOptions.CustomProperties.CustomPropertyValue"] = {
			"/System/Core/ATLNZ-Relay/ATLNZ/ATLNZ-V305-Con02/1823907_PLS4000_ATS00753/PROD/GenTemplate Companions/Generic R215-Mapping.TableData",
			"PROD",
		},
		...
		references = {
			{
                path = "/System/Core/ATLNZ-Relay/ATLNZ/ATLNZ-V305-Con02/1823907_PLS4000_ATS00753/PROD/LIQS/4112_Ausruestung_Ansatzbereitung/R215_Ansatzbereitung_Daten__1825486/trigg_report",
                name = '_trigger_io_',
                type = 'OBJECT_LINK'
            }
        }

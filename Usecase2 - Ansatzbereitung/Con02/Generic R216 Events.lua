...
return EVENTS:RUN(CONF, mapping_table, equipment)]=],
		...
		["CustomOptions.CustomProperties.CustomPropertyValue"] = {
			"/System/Core/ATLNZ-Relay/ATLNZ/ATLNZ-V305-Con02/1823907_PLS4000_ATS00753/PROD/GenTemplate Companions/Generic R216-Mapping.TableData",
			"PROD",
		},
		...
		references = {
			{
                path = "/System/Core/ATLNZ-Relay/ATLNZ/ATLNZ-V305-Con02/1823907_PLS4000_ATS00753/PROD/LIQS/4112_Ausruestung_Ansatzbereitung/R216_Ansatzbereitung_Daten__1825487/trigg_report",
                name = '_trigger_io_',
                type = 'OBJECT_LINK'
            }
        }

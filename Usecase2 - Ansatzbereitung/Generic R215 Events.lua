...
local CONF = {
    ...
    Event =
    {
        ...
        customData = {
            ...
            { key = "vRot_4111-p3SI282",        centralMapping = { key = "vRot_4111-p3SI282" } },
            { key = "T_container_4111-p3TI241", centralMapping = { key = "T_container_4111-p3TI241" } },
...
return EVENTS:RUN(CONF, mapping_table, equipment)]=],
		...
		references = {
			{
                path = "/System/Core/ATLNZ-Relay/ATLNZ/ATLNZ-V305-Con01/1823907_PLS4000_ATS00753/PROD/LIQS/4112_Ausruestung_Ansatzbereitung/R215_Ansatzbereitung_Daten__1825486/trigg_report",
                name = '_trigger_io_',
                type = 'OBJECT_LINK'
            }
        }
